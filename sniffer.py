...
def main():
    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            print(
                TAB_3 + 'protocol: {}, Source: {}, Target: {}'.format(proto, src, target))
            ...
            # TCP
                ...
                print(
                    TAB_2 + 'Sequence: {}, Acknowledgment: {}'.format(sequence, acknowledgment))
                print(TAB_2 + 'Flags:')
                print(
...
def tcp_seg(data):
    (src_port, destination_port, sequence, acknowledgenment,
     offset_reserv_flag) = struct.unpack('! H H L L H', data[:14])
